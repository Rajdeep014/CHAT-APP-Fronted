...
import { useSendAttachemntsMutation } from "../../redux/api/api";
...
const FileMenu = ({ anchorE1, chatId }) => {
  ...
  const [sendAttachments] = useSendAttachemntsMutation();
  ...
  const fileChangeHandler = async (e, key) => {
    ...
    if (files.length > 5)
      return toast.error(`You can only select 5 ${key} at a time`);
